...
> **Status: scaffold.** The architecture, interfaces, event loop, config, and
> test/CI harness are in place. Concrete components (historic data handler,
> MA-crossover strategy, risk-based portfolio, simulated executor, metrics) are
> the next build step — see [`BACKTESTER_SPEC.md`](BACKTESTER_SPEC.md).
